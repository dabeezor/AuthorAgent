/**
 * AuthorAgent Memory Search
 *
 * SQLite + FTS5 full-text search across every conversation turn AuthorAgent
 ...
 *      available on this machine), the rest of AuthorAgent keeps working
